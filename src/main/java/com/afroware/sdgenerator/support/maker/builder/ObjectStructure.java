package com.afroware.sdgenerator.support.maker.builder;
...
import com.afroware.sdgenerator.util.BuildUtils;
...
public class ObjectStructure {
    ...
    public static class ObjectConstructor {
        ...
        public ObjectConstructor addArgument(String argumentClass, String argumentName) {
            constructorArguments.add(new Pair<>(argumentClass, BuildUtils.cleanSpaces(argumentName)));
            return this;
        }
    ...
    public static class ObjectFunction {
        ...
        public ObjectFunction(ScopeValues functionScope, String functionName, String functionReturnType ,   Boolean signature ) {
        	this(functionScope, functionName, functionReturnType);
		...
		public ObjectFunction addArgument(String argumentClass, String argumentName) {
            functionArguments.add(new Pair<>(argumentClass, BuildUtils.cleanSpaces(argumentName)));
            return this;
        }
        ...
        @Override
        public String toString() {
            return BuildUtils.buildFunction(functionAnnotations, functionScope, functionReturnType, functionName, functionArguments, functionBody, functionReturn,signature);
        }
    ...
    public static class ObjectMethod {
        ...
        public ObjectMethod(ScopeValues methodScope, String methodName , Boolean signature) {
            this(methodScope, methodName);
            this.signature = signature;
        }
		...
		public ObjectMethod addArgument(String argumentClass, String argumentName) {
            methodArguments.add(new Pair<>(argumentClass, BuildUtils.cleanSpaces(argumentName)));
            return this;
        }
        ...
        @Override
        public String toString() {
            return BuildUtils.buildMethod(methodAnnotations, methodScope, methodName, methodArguments, methodBody,signature);
        }
