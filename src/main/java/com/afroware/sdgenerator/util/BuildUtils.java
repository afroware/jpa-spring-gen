...
import com.afroware.sdgenerator.support.maker.values.CommonValues;
...
public class BuildUtils {
    ...
    public static String buildConstructor(String annotations, ScopeValues scope, String objectName, Set<Pair<Object, Object>> arguments, String body) {
        return buildStructure(annotations, scope, null, objectName, arguments, body, null,null);
    }

    public static String buildFunction(String annotations, ScopeValues scope, String returnStructure, String objectName, Set<Pair<Object, Object>> arguments, String body, String returnString ,Boolean signature) {
        return buildStructure(annotations, scope, returnStructure, objectName, arguments, body, returnString,signature);
    }

    public static String buildMethod(String annotations, ScopeValues scope, String objectName, Set<Pair<Object, Object>> arguments, String body,Boolean signature) {
        return buildStructure(annotations, scope, "void", objectName, arguments, body, null,signature);
    }

    public static String buildStructure(String annotations, ScopeValues scope, String returnStructure, String objectName, Set<Pair<Object, Object>> arguments, String body, String returnString, Boolean signature) {
        ...
        if(signature != null && signature) {
        	 constructor.append(CommonValues.SEMICOLON);
        }else {
        	constructor.append(CommonValues.KEY_START)
