...
public class CustomResourceLoader implements ResourceLoader {
	...
	public String getRepositorySuperClassName() {
		return repositorySuperClassName;
	}

	public void setRepositorySuperClassName(String repositorySuperClassName) {
		this.repositorySuperClassName = repositorySuperClassName;
	}
